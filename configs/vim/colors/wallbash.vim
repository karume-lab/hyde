...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['222222', '828282', '949494', '949494',
                                \ '828282', 'B8B8B8', 'B8B8B8', '0F1110',
                                \ '624855', '949494', 'B8B8B8', 'D6D6D6',
                                \ '949494', 'D6D6D6', 'D6D6D6', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', 'B8B8B8', 'D6D6D6', 'D6D6D6',
                                \ 'B8B8B8', 'FCFCFC', 'FCFCFC', 'C86B94',
                                \ '0F1110', 'D6D6D6', 'FCFCFC', 'FCFCFC',
                                \ 'D6D6D6', 'FCFCFC', 'FCFCFC', '222222']
  endif
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#C86B94 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#C86B94 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#624855 gui=NONE cterm=NONE
  ...
  hi NeoTreeWinSeparator guifg=#624855 guibg=NONE gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#C86B94 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#222222 guibg=#FCFCFC gui=bold cterm=bold
  hi TabLineSeparator guifg=#828282 guibg=#C86B94 gui=NONE cterm=NONE

  " Interactive elements with dynamic contrast
  hi Search guifg=#624855 guibg=#D6D6D6 gui=NONE cterm=NONE
  hi Visual guifg=#624855 guibg=#B8B8B8 gui=NONE cterm=NONE
  hi MatchParen guifg=#624855 guibg=#FCFCFC gui=bold cterm=bold
  ...
  hi CmpItemAbbrDeprecated guifg=#0F1110 guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#FCFCFC guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#0F1110 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyGroup guifg=#B8B8B8 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyDesc guifg=#D6D6D6 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyFloat guibg=#624855 guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#C86B94 gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#624855 guibg=#B8B8B8 gui=NONE cterm=NONE
  hi IncSearch guifg=#624855 guibg=#FCFCFC gui=NONE cterm=NONE
  hi NormalNC guibg=#624855 guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#D6D6D6 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#624855 guibg=#FCFCFC gui=bold cterm=bold

  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#FCFCFC guibg=#624855 gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#C86B94 gui=italic cterm=italic
  ...
  " hi NeoTreeCursorLine guibg=#B8B8B8 guifg=#222222 gui=bold cterm=bold
  ...
  hi WinBar guifg=#FFFFFF guibg=#C86B94 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#624855 gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#FCFCFC guifg=#222222 gui=bold cterm=bold
  hi BufferTabpageFill guibg=#222222 guifg=#0F1110 gui=NONE cterm=NONE
  ...
  hi BufferCurrentSign guifg=#FCFCFC guibg=#624855 gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#C86B94 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#C86B94 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#B8B8B8 guibg=#624855 gui=NONE cterm=NONE
  hi BufferInactive guifg=#0F1110 guibg=#624855 gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#828282 guibg=#624855 gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#828282 guibg=#624855 gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#222222 gui=NONE cterm=NONE
  hi Pmenu guibg=#0F1110 guifg=#222222 gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#3D3D3D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#222222 guibg=#FFFFFF gui=NONE cterm=NONE
  hi VertSplit guifg=#3D3D3D guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#3D3D3D guibg=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#624855 guibg=NONE gui=NONE cterm=NONE

  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#222222 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#222222 gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#222222 gui=NONE cterm=NONE
  ...
  " TabLine highlighting with complementary accents
  hi TabLine guifg=#222222 guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  ...
  hi CmpItemMenu guifg=#624855 guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#222222 guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#C86B94 guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#1A1A1A guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#C86B94 guibg=NONE gui=NONE cterm=NONE
  ...
  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#0F1110 gui=NONE cterm=NONE
  hi Cursor guibg=#222222 guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  hi TermCursor guibg=#222222 guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#222222 gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  ...
  hi NormalNC guibg=#FFFFFF guifg=#624855 gui=NONE cterm=NONE
  ...
  hi FoldColumn guifg=#624855 guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#222222 guibg=#0F1110 gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#222222 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#222222 gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#1A1A1A guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#222222 guibg=NONE gui=NONE cterm=NONE
  ...
  hi WinBar guifg=#222222 guibg=#0F1110 gui=bold cterm=bold
  hi WinBarNC guifg=#624855 guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#1A1A1A guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#C86B94 gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#222222 guibg=#0F1110 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#624855 guibg=#0F1110 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#3D3D3D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#C86B94 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi TelescopeSelection guibg=#FCFCFC guifg=#222222 gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#FCFCFC gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#B8B8B8 guifg=#222222 gui=bold cterm=bold
hi TelescopeMatching guifg=#949494 guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#FCFCFC guifg=#222222 gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#FCFCFC guifg=#222222 gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#FCFCFC guifg=#222222 gui=bold
hi WildMenu guibg=#FCFCFC guifg=#222222 gui=bold
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#FCFCFC guifg=#222222 gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#FCFCFC guifg=#222222 gui=bold cterm=bold |
    \ else |
